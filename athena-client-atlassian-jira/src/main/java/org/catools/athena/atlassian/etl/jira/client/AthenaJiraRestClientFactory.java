...
public class AthenaJiraRestClientFactory extends AsynchronousJiraRestClientFactory
  ...
  public JiraRestClient create(
    ...
    final DisposableHttpClient httpClient =
        new AthenaHttpClientFactory()
            .createClient(5, TimeUnit.MINUTES, serverUri, authenticationHandler);
