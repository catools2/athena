...
CREATE DATABASE athena WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';
...
COPY athena_tms.cycle (hash, end_date, id, start_date, version_id, code, name) FROM stdin;
\.
...
--
-- Name: cycle cycle_hash_key; Type: CONSTRAINT; Schema: athena_tms; Owner: postgres
--

ALTER TABLE ONLY athena_tms.cycle
    ADD CONSTRAINT cycle_hash_key UNIQUE (hash);
