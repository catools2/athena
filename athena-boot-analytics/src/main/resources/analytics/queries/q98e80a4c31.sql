select distinct i.item_key, i.name, i.rca_set ->>0 as rca, area as functional_area, i.item_version_set as versions, i.item_status, i.created_on, i.updated_on, i.teams_set as team
