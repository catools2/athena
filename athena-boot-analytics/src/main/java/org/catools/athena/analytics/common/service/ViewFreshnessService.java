...
public class ViewFreshnessService {
  ...
  public List<QueryResultDto.ViewFreshness> of(List<String> views) {
    ...
    return views.stream()
        .map(view -> {
          ...
          if (entry == null) {
            ...
            return new QueryResultDto.ViewFreshness(view, null, false);
          }
          return new QueryResultDto.ViewFreshness(view, entry.refreshedAt(), true);
        })
        .toList();
  }
