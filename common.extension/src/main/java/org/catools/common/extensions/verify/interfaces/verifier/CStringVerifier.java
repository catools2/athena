 ...
 */
public interface CStringVerifier extends CObjectVerifier<String, CStringState>, CStringVerify {
  ...
  default void verifyContains(final CVerificationQueue verifier, final String expected) {
    verifyContains(
        verifier, expected, getDefaultMessage("Value Contains The Expected Value"));
  }
  ...
  default void verifyContainsAnyIgnoreCase(
      CVerificationQueue verifier, List<String> expectedList) {
  ...
  default void verifyEndsWith(final CVerificationQueue verifier, String suffix) {
    verifyEndsWith(
        verifier, suffix, getDefaultMessage("Value Ends With The Expected Value"));
  }
  ...
  default void verifyIsAlphanumeric(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isAlphanumeric(), message, params);
  }
  ...
  default void verifyIsAsciiPrintable(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isAsciiPrintable(), message, params);
  }
  ...
  default void verifyIsBlankOrAlpha(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isBlankOrAlpha(), message, params);
  }
  ...
  default void verifyIsBlankOrNotAlpha(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isBlankOrNotAlpha(), message, params);
  }
  ...
  default void verifyIsBlankOrNumeric(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isBlankOrNumeric(), message, params);
  }
  ...
  default void verifyIsEmptyOrAlpha(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isEmptyOrAlpha(), message, params);
  }
  ...
  default void verifyIsEmptyOrNotAlpha(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isEmptyOrNotAlpha(), message, params);
  }
  ...
  default void verifyIsEmptyOrNumeric(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isEmptyOrNumeric(), message, params);
  }
   ...
   */
  default void waitMatchesAny(final CVerificationQueue verifier, final List<Pattern> patterns) {
    _verify(
        verifier,
        patterns,
   ...
   * @param patterns regular expression pattern
   */
  default void waitMatchesNone(final CVerificationQueue verifier, final List<Pattern> patterns) {
    waitMatchesNone(
        verifier,
        patterns,
  ...
  default void waitMatchesNone(
      ...
      final Object... params) {
    _verify(
        verifier, patterns, (a, b) -> _toState(a).matchNone(b), message, params);
  }
  ...
  default void verifyMatches(final CVerificationQueue verifier, final Pattern pattern) {
    verifyMatches(
        verifier, pattern, getDefaultMessage("Value Matches The Provided Pattern"));
  }
  ...
  default void verifyIsNotAlpha(final CVerificationQueue verifier) {
    verifyIsNotAlpha(
        verifier, getDefaultMessage("Value Not Contains Only Alpha Characters"));
  }
  ...
  default void verifyIsNotAlphaSpace(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isNotAlphaSpace(), message, params);
  }
  ...
  default void verifyIsNotAlphanumeric(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isNotAlphanumeric(), message, params);
  }
  ...
  default void verifyNotMatches(
      ...
      final Object... params) {
    _verify(
        verifier, pattern, (a, b) -> _toState(a).notMatches(b), message, params);
  }
  ...
  default void verifyIsNotNumeric(final CVerificationQueue verifier) {
    verifyIsNotNumeric(
        verifier, getDefaultMessage("Value Not Contains Only Numeric Characters"));
  }
  ...
  default void verifyIsNotNumericSpace(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isNotNumericSpace(), message, params);
  }
  ...
  default void verifyIsNumericSpace(
      CVerificationQueue verifier, final String message, final Object... params) {
    _verify(
        verifier, true, (a, b) -> _toState(a).isNumericSpace(), message, params);
  }
  ...
  default void verifyNotContains(
      ...
      final Object... params) {
    _verify(
        verifier, expected, (a, b) -> _toState(a).notContains(b), message, params);
  }
  ...
  default void verifyNotEndsWith(
      ...
      final Object... params) {
    _verify(
        verifier, suffix, (a, b) -> _toState(a).notEndsWith(b), message, params);
  }
  ...
  default void verifyStartsWith(
      ...
      final Object... params) {
    _verify(
        verifier, expected, (a, b) -> _toState(a).startsWith(b), message, params);
  }
   ...
   */
  default void verifyStartsWithAny(
      CVerificationQueue verifier, List<String> searchInputs) {
    verifyStartsWithAny(
        verifier,
        searchInputs,
