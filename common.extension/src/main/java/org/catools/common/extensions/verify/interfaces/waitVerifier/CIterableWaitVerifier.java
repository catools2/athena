...
public interface CIterableWaitVerifier<E, C extends Iterable<E>> extends CIterableVerifier<E, C>, CObjectWaitVerifier<C, CIterableState<E, C>> {
  ...
  default void verifyContains(
      CVerificationQueue verifier, E expected, final int waitInSeconds) {
    verifyContains(
  ...
  default void verifyContains(
    ...
    _verify(
        verifier,
        expected,
        (a, e) -> CIterableUtil.contains(_get(), e),
        waitInSeconds,
        intervalInMilliSeconds,
        message,
        params);
  ...
  default void verifyContainsAll(
      CVerificationQueue verifier, C expected, final int waitInSeconds) {
    verifyContainsAll(
        verifier, expected, waitInSeconds, getDefaultWaitIntervalInMilliSeconds());
  }
   ...
   */
  default void verifyHas(
      CVerificationQueue verifier, Predicate<E> expected, final int waitInSeconds) {
  ...
  default void verifyIsEmpty(
      ...
      final int intervalInMilliSeconds) {
    verifyIsEmpty(
        verifier, waitInSeconds, intervalInMilliSeconds, getDefaultMessage("Is Empty"));
  }
  ...
  default void verifyIsEmpty(
    ...
    _verify(
        verifier,
        true,
        (a, e) -> CIterableUtil.isEmpty(_get()),
        waitInSeconds,
        intervalInMilliSeconds,
        message,
        params);
