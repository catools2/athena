...
class ProjectFactory(factory.Factory):
    ...
    code = factory.LazyFunction(lambda: f"P{random.randint(1, 100000000)}")
    name = factory.LazyFunction(lambda: f"{fake.user_name()} {random.randint(1, 1000000)}")
...
class VersionFactory(factory.Factory):
    ...
    code = factory.LazyFunction(lambda: f"V{random.randint(1, 100000000)}")
    name = factory.LazyFunction(lambda: f"{fake.user_name()} {random.randint(1, 100000000)}")
    project = None
...
class EnvironmentFactory(factory.Factory):
    ...
    code = factory.LazyFunction(lambda: f"E{random.randint(1, 100000000)}")
    name = factory.LazyFunction(lambda: f"{fake.user_name()} {random.randint(1, 100000000)}")
    project = None
...
class AliasFactory(factory.Factory):
    ...
    alias = factory.LazyFunction(lambda: f"{fake.user_name()}.{random.randint(1, 10000)}")
...
class UserFactory(factory.Factory):
    ...
    username = factory.LazyFunction(lambda: f"{fake.user_name()}.{random.randint(1, 10000)}")
