package org.catools.athena.core.pact.provider;
...
import static org.catools.athena.core.pact.consumer.CorePactTestConstants.*;
...
class UserControllerPactProviderTest extends CoreControllerTest {
  ...
  @State("GetUserById")
  void getUser() {
    ResponseEntity<UserDto> response = userController.getById(USER_DTO.getId());
