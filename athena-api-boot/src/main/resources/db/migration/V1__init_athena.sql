...
alter table if exists athena_openapi.api add constraint FKdlxwlfd1dp5pymn9pnt7gq9c2 foreign key (api_spec_id) references athena_openapi.api_spec;
...
alter table if exists athena_openapi.server_metadata_mid add constraint FKq71fj72q36ap7q7bmpbmf59v9 foreign key (metadata_id) references athena_openapi.api_metadata;
alter table if exists athena_openapi.server_metadata_mid add constraint FK5ilsqmc73evthbqxqln1xhgai foreign key (path_id) references athena_openapi.api;
