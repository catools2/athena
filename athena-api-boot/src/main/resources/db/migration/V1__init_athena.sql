...
create table athena_core.app_version (id bigserial not null, project_id bigint not null, code varchar(10) not null unique, name varchar(50) not null, primary key (id));
...
alter table if exists athena_core.app_version add constraint FK5s3l6egklax4c0brnv7yp9cpt foreign key (project_id) references athena_core.project;
