...
public class PriorityController {
  ...
  @Operation(
      summary = "Retrieve priority by code",
      responses = {
          @ApiResponse(responseCode = "200", description = "Successfully retrieved data"),
          @ApiResponse(responseCode = "204", description = "No content to return")
      })
  public ResponseEntity<PriorityDto> getByCode(
      @Parameter(name = "code", description = "The code of the priority to retrieve")
      @RequestParam final String code
  ) {
    return ResponseEntityUtils.okOrNoContent(priorityService.getByCode(code));
  }
