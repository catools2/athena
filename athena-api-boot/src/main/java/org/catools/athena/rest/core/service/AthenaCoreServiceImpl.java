...
public class AthenaCoreServiceImpl implements AthenaCoreService {
  ...
  public List<ProjectDto> getProjects() {
    ...
    return projects.stream().map(athenaCoreMapper::projectToProjectDto).toList();
  }
  ...
  public List<EnvironmentDto> getEnvironments() {
    ...
    return environments.stream().map(athenaCoreMapper::environmentToEnvironmentDto).toList();
  }
  ...
  public List<UserDto> getUsers() {
    ...
    return users.stream().map(athenaCoreMapper::userToUserDto).toList();
  }
