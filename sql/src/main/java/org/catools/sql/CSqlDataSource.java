...
public class CSqlDataSource {
  ...
  public static class QueryString {
    ...
    public static String query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<String> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static String query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<String> retryCondition, int retryCount, int interval, String orElse) {
  ...
  public static class QueryDate {
    ...
    public static Date query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Date> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static Date query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Date> retryCondition, int retryCount, int interval, Date orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryInt {
    ...
    public static Integer query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Integer> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static Integer query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Integer> retryCondition, int retryCount, int interval, Integer orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryLong {
    ...
    public static Long query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Long> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static Long query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Long> retryCondition, int retryCount, int interval, Long orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryDouble {
    ...
    public static Double query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Double> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static Double query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<Double> retryCondition, int retryCount, int interval, Double orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryBigDecimal {
    ...
    public static BigDecimal query(String sql, String dbSource, Predicate<BigDecimal> retryCondition, int retryCount, int interval, BigDecimal orElse) {
      return query(sql, new MapSqlParameterSource(), dbSource, retryCondition, retryCount, interval, orElse);
    }

    public static BigDecimal query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<BigDecimal> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static BigDecimal query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<BigDecimal> retryCondition, int retryCount, int interval, BigDecimal orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryList {
    ...
    public static <T> CList<T> query(String sql, RowMapper<T> rowMapper, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval) {
      return query(sql, rowMapper, dbSource, retryCondition, retryCount, interval, new CList<>());
    }

    public static <T> CList<T> query(String sql, RowMapper<T> rowMapper, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval, CList<T> orElse) {
      return doWithRetry(integer -> query(sql, rowMapper, dbSource), retryCondition, retryCount, interval, orElse);
    }

    public static <T> CList<T> query(String sql, Class<T> elementType, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval) {
      return query(sql, elementType, dbSource, retryCondition, retryCount, interval, new CList<>());
    }

    public static <T> CList<T> query(String sql, Class<T> elementType, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval, CList<T> orElse) {
    ...
    public static <T> CList<T> query(String sql, MapSqlParameterSource paramSource, RowMapper<T> rowMapper, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, rowMapper, dbSource, retryCondition, retryCount, interval, new CList<>());
    }

    public static <T> CList<T> query(String sql, MapSqlParameterSource paramSource, RowMapper<T> rowMapper, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval, CList<T> orElse) {
      return doWithRetry(integer -> query(sql, paramSource, rowMapper, dbSource), retryCondition, retryCount, interval, orElse);
    }

    public static <T> CList<T> query(String sql, MapSqlParameterSource paramSource, Class<T> elementType, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, elementType, dbSource, retryCondition, retryCount, interval, new CList<>());
    }

    public static <T> CList<T> query(String sql, MapSqlParameterSource paramSource, Class<T> elementType, String dbSource, Predicate<CList<T>> retryCondition, int retryCount, int interval, CList<T> orElse) {
      return doWithRetry(integer -> query(sql, paramSource, elementType, dbSource), retryCondition, retryCount, interval, orElse);
    }

    public static CList<Map<String, Object>> query(String sql, String dbSource, Predicate<CList<Map<String, Object>>> retryCondition, int retryCount, int interval) {
      return query(sql, dbSource, retryCondition, retryCount, interval, new CList<>());
    }

    public static CList<Map<String, Object>> query(String sql, String dbSource, Predicate<CList<Map<String, Object>>> retryCondition, int retryCount, int interval, CList<Map<String, Object>> orElse) {
      return query(sql, new MapSqlParameterSource(), dbSource, retryCondition, retryCount, interval, orElse);
    }

    public static CList<Map<String, Object>> query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<CList<Map<String, Object>>> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, new CList<>());
    }

    public static CList<Map<String, Object>> query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<CList<Map<String, Object>>> retryCondition, int retryCount, int interval, CList<Map<String, Object>> orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryMap {
    ...
    public static CHashMap<String, Object> query(String sql, String dbSource, Predicate<CHashMap<String, Object>> retryCondition, int retryCount, int interval) {
      return query(sql, dbSource, retryCondition, retryCount, interval, null);
    }

    public static CHashMap<String, Object> query(String sql, String dbSource, Predicate<CHashMap<String, Object>> retryCondition, int retryCount, int interval, CHashMap<String, Object> orElse) {
      return query(sql, new MapSqlParameterSource(), dbSource, retryCondition, retryCount, interval, orElse);
    }

    public static CHashMap<String, Object> query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<CHashMap<String, Object>> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static CHashMap<String, Object> query(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<CHashMap<String, Object>> retryCondition, int retryCount, int interval, CHashMap<String, Object> orElse) {
      return doWithRetry(integer -> query(sql, paramSource, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryObject {
    ...
    public static <T> T query(String sql, RowMapper<T> rowMapper, String dbSource, Predicate<T> retryCondition, int retryCount, int interval, T orElse) {
      return query(sql, new MapSqlParameterSource(), rowMapper, dbSource, retryCondition, retryCount, interval, orElse);
    }

    public static <T> T query(String sql, MapSqlParameterSource paramSource, RowMapper<T> rowMapper, String dbSource, Predicate<T> retryCondition, int retryCount, int interval) {
      return query(sql, paramSource, rowMapper, dbSource, retryCondition, retryCount, interval, null);
    }

    public static <T> T query(String sql, MapSqlParameterSource paramSource, RowMapper<T> rowMapper, String dbSource, Predicate<T> retryCondition, int retryCount, int interval, T orElse) {
      return doWithRetry(integer -> query(sql, paramSource, rowMapper, dbSource), retryCondition, retryCount, interval, orElse);
    }
  }
  ...
  public static class QueryBlob {
    ...
    public static String queryAsString(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<String> retryCondition, int retryCount, int interval) {
      return queryAsString(sql, paramSource, dbSource, retryCondition, retryCount, interval, null);
    }

    public static String queryAsString(String sql, MapSqlParameterSource paramSource, String dbSource, Predicate<String> retryCondition, int retryCount, int interval, String orElse) {
  ...
  private static <R> R doAction(String actionName, String dbSource, String sql, MapSqlParameterSource parameters, Function<NamedParameterJdbcTemplate, R> action) {
