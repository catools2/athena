...
public class AthenaEnvironmentControllerTest extends AthenaControllerTest {
  ...
  public void beforeAll() {
    PROJECT_DTO = athenaProjectController.saveProject(PipelineBuilder.buildProjectDto()).getBody();
