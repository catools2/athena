...
public class FeignUtils {
  ...
  public static <T> T getClient(
      Class<T> clazz, String host, String token, int connectTimeout, int readTimeout) {
    return getClientBuilder(clazz, connectTimeout, readTimeout)
        .requestInterceptor(
            requestTemplate -> {
  ...
  public static <T> Feign.Builder getClientBuilder(
      Class<T> clazz, int connectTimeout, int readTimeout) {
  ...
  @NotNull public static Optional<Long> getEntityId(Response response) {
    try {
