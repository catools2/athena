create table athena_tms.cycle (end_date TIMESTAMPTZ, id bigserial not null, start_date TIMESTAMPTZ not null, version_id bigint, code varchar(10) not null unique, name varchar(300) not null, primary key (id));
