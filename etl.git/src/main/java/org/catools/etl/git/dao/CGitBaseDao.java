...
@Slf4j
public class CGitBaseDao {
  private static EntityManagerFactory entityManagerFactory = null;

  static {
    Runtime.getRuntime().addShutdownHook(new Thread(CGitBaseDao::closeEntityManagerFactory));
  }
  ...
  protected static synchronized EntityManagerFactory getEntityManagerFactory() {
    if (entityManagerFactory == null) {
      entityManagerFactory = CRetry.retry(idx -> {
        ...
        return Persistence.createEntityManagerFactory("CGitPersistence");
      }, 10, 10);
    }
