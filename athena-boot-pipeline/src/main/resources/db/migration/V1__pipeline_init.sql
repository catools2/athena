...
create table athena_pipeline.pipeline_metadata (id bigserial not null, name varchar(100) not null, value varchar(2000) not null, primary key (id), constraint uk_pipeline_metadata_name_value unique (name, value));
