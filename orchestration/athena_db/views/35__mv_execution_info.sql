-- athena.mv_execution_info
-- type      : MATERIALIZED VIEW
-- dep level : 5
-- depends on: mvw_execution_info
--
...
DROP MATERIALIZED VIEW IF EXISTS athena.mv_execution_info CASCADE;

CREATE MATERIALIZED VIEW athena.mv_execution_info
...
AS SELECT start_time_rank,
    ...
    item_key,
    item_id
   FROM athena.mvw_execution_info t
WITH DATA;
