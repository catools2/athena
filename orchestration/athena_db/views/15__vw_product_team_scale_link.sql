-- athena.vw_product_team_scale_link
-- type      : VIEW
-- dep level : 0
...
DROP VIEW IF EXISTS athena.vw_product_team_scale_link CASCADE;

CREATE OR REPLACE VIEW athena.vw_product_team_scale_link AS
...
LEFT JOIN athena_tms.item i ON i.id = imm.item_id
