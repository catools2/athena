...
template:
  metadata:
    labels:
      ...
      {{- end }}
    annotations:
      checksum/event-bus-configmap: {{ include (print $.Template.BasePath "/selenium/event-bus-configmap.yaml") . | sha256sum }}
      checksum/node-configmap: {{ include (print $.Template.BasePath "/selenium/node-configmap.yaml") . | sha256sum }}
      checksum/logging-configmap: {{ include (print $.Template.BasePath "/selenium/logging-configmap.yaml") . | sha256sum }}
      checksum/server-configmap: {{ include (print $.Template.BasePath "/selenium/server-configmap.yaml") . | sha256sum }}
